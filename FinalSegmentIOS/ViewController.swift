...
////  FinalSegmentIOS
////
////  Created by Mrunmayi Shinde on 13/03/25.
////
//
//// ViewController.swift - Main view controller with tracking examples
//
...
//        let stackView = UIStackView(arrangedSubviews: [loginButton, trackEventButton, purchaseButton, showAppInboxButton,pushNotificationButton,nativeDisplay])
